...
VDP_DoWait:
	push bc
		ld b,AmsDap
		ld c,Vdp9k_Status
		in a,(c)	;S#2  [TR ] [VR ] [HR ] [BD ] [ 1 ] [ 1 ] [EO ] [CE ] - Status register 2
	pop bc
	rra
	ret nc
	jr VDP_DoWait
...
VDP_HMMM:	;(High speed move VRAM to VRAM) (Blit Bytes)
	push bc
		...
		;outi x 12
		defb &ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04
	;&ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04
...
;	outi X 8
	defb &ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04,&ED,&A3,&04

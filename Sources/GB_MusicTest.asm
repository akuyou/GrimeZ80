...
;	call SetGBPaletteDark
	...
	ld a,%11110011 ;%VVVVDNNN C1 Volume / Direction 0=down / envelope Number (fade speed)
	ld (&FF21),a
	
	ld a,%00111011	;SSSSCDDD Shift clock frequency (pitch) / Counter Step 0=15bit 1=7bit (sounds eletronic)/ Dividing ratio (roughness)
	ld (&FF22),a
